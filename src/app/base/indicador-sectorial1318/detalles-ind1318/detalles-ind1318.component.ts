...
@Component({
  selector: 'app-detalles-ind1318',
  templateUrl: './detalles-ind1318.component.html',
  styleUrls: ['./detalles-ind1318.component.scss']
})
export class DetallesInd1318Component {
